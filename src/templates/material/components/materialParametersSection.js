...
const MaterialParametersSection = ({
  t,
  parameterRows,
  ...
  return (
    <div className="material-parameters-table-wrap">
      ...
      <div className="js-acc-body">
              ...
              {parameterRows.map((parameter, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className="p--p1 material-parameters-value"
                      data-label={leftValue}
                    >
                      {rightValue}
                    </td>
                  </tr>
        ...
        {hasTechnicalSpecifications && (
          <div className="article material-parameters-extra">
            <div className="article-content">
              {renderRichText(technicalSpecifications, renderOptions)}
            </div>
          </div>
        )}
      </div>
